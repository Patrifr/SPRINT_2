...
db.restaurants.find({$or: [{$and: [{cuisine: 'Seafood'}, {cuisine: {$nin: ['American', 'Chinese']}}]}, {name: /^Wil/i}]}, {restaurant_id: 1, name: 1, borough: 1, cuisine: 1})
...
db.restaurants.find({name: /^Mad/i}, {restaurant_id: 1, name: 1, borough: 1, 'address.coord': 1, cuisine: 1})